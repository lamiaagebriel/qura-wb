export const ar = {
  ...
  "Post your content": "انشر محتواك",
  "Share your menu, announce an event, post a rental, list a job. Everything you publish appears in the city feed instantly.":
    "شارك قائمتك، أعلن عن فعالية، انشر إيجاراً، أضف وظيفة. كل ما تنشره يظهر في تدفق المدينة مباشرة.",
  "Connect on WhatsApp": "تواصل عبر واتساب",
  "Every inquiry, order, or reservation goes straight to your WhatsApp. No middleman. No commission. Just real conversations.":
    "كل استفسار أو طلب أو حجز يصلك مباشرة على واتساب. بدون وسيط، ولا عمولة. محادثات حقيقية فقط.",
  ...
  "Live in your city right now": "مباشرة من مدينتك الآن",
  "Everything in one place": "كل شيء في مكان واحد",
  "One account. Pick your categories. Reach your whole city.":
    "حساب واحد. اختر فئاتك. تواصل مع كل مدينتك.",
  "Up and running in minutes": "جاهز في دقائق",
  "No technical skills required. No approval process.":
    "لا مهارات تقنية مطلوبة. لا توجد عملية موافقة.",
  "WhatsApp is the only CTA": "واتساب هو زر الإجراء الوحيد",
  "No in-app payments. No booking forms. When a customer is ready, they tap one button and land in your WhatsApp chat with the full order or inquiry already typed. You handle it your way, on your terms.":
    "لا مدفوعات داخل التطبيق. لا نماذج حجز. عندما يكون العميل جاهزاً، يضغط زرًا واحدًا ويصل مباشرة إلى محادثة واتساب مع تفاصيل الطلب أو الاستفسار مكتوبة مسبقًا. أنت تتعامل معها بطريقتك، وبشروطك.",
  "Be first": "كن الأول",
  "Your city is waiting.": "مدينتك تنتظرك.",
  "Put yourself on the map.": "ضع نفسك على الخريطة.",
  "Create your free profile today. No credit card. No approval.\nGo live in minutes.":
    "أنشئ ملفك المجاني اليوم. بدون بطاقة ائتمان. بدون موافقة.\nمباشر خلال دقائق.",
  ...
  // Auth — signup
  "Join your city's feed — it takes less than a minute.":
    "انضم إلى تدفق مدينتك — الأمر يستغرق أقل من دقيقة.",
  ...
  "You're signed in — send a reset link for this account, or change the email below to reset a different one.":
    "لقد سجّلت الدخول بالفعل — أرسل رابط إعادة التعيين لهذا الحساب، أو غيّر البريد الإلكتروني أدناه لإعادة تعيين كلمة مرور حساب آخر.",
  ...
  "Resend available in {{seconds}}s":
    "إعادة الإرسال متاحة خلال {{seconds}} ثانية",
  "Set a new password": "تعيين كلمة مرور جديدة",
  "Make it strong — you'll use it to sign back in.":
    "اجعلها قوية — ستستخدمها لتسجيل الدخول مجدداً.",
  ...
  "Password reset links are only valid for a little while. Request a new one to continue.":
    "روابط إعادة تعيين كلمة المرور صالحة لفترة قصيرة فقط. اطلب رابطاً جديداً للمتابعة.",
  "Request a new link": "طلب رابط جديد",
  "Password updated": "تم تحديث كلمة المرور",
  "Your password has been changed. You can now sign in.":
    "تم تغيير كلمة المرور الخاصة بك. يمكنك الآن تسجيل الدخول.",
  ...
  "Click it to activate your profile and start posting.":
    "اضغط عليه لتفعيل ملفك الشخصي والبدء في النشر.",
  ...
  "Hang tight, this only takes a second.":
    "لحظات فقط، الأمر لن يستغرق وقتاً طويلاً.",
  "You're verified!": "تم التحقق من حسابك!",
  "Your account is active. Time to explore your city.":
    "حسابك الآن مُفعّل. حان وقت استكشاف مدينتك.",
  ...
  "This link is invalid or has expired. Request a new verification email to continue.":
    "هذا الرابط غير صالح أو منتهي الصلاحية. اطلب رسالة تحقق جديدة للمتابعة.",
  ...
  // Auth — server-side errors
  "An account with this email already exists. Try signing in instead.":
    "يوجد حساب بهذا البريد الإلكتروني مسبقاً. جرّب تسجيل الدخول بدلاً من ذلك.",
  "Invalid email.": "البريد الإلكتروني غير صحيح.",
  "Invalid password.": "كلمة المرور غير صحيحة.",
  "This account uses {{provider}} sign-in. Continue with {{provider}} instead.":
    "هذا الحساب يستخدم تسجيل الدخول عبر {{provider}}. تابع باستخدام {{provider}} بدلاً من ذلك.",
  ...
  'This email is linked to your {{provider}} account. Sign in with {{provider}}, or use "Forgot password" to set one.':
    'هذا البريد الإلكتروني مرتبط بحساب {{provider}} الخاص بك. سجّل الدخول باستخدام {{provider}}، أو استخدم "نسيت كلمة المرور" لتعيين واحدة.',
  ...
  "Something went wrong signing in with Google. Please try again.":
    "حدث خطأ أثناء تسجيل الدخول عبر Google. الرجاء المحاولة مرة أخرى.",
  "Google sign-in isn't available right now.":
    "تسجيل الدخول عبر Google غير متاح حالياً.",

  // Auth — verify email (post-verification CTA)
  "Go to your dashboard": "الذهاب إلى لوحة التحكم",

  // Dashboard
  Dashboard: "لوحة التحكم",
  "Welcome back, {{name}}.": "أهلاً بعودتك، {{name}}.",
  "Here's your account at a glance.": "نظرة سريعة على حسابك.",
  Account: "الحساب",
  Verified: "تم التحقق",
  Joined: "تاريخ الانضمام",
  "Signed in with": "تسجيل الدخول عبر",
  ...
  "Profile creation is coming in the next step — once it's ready, you'll be able to publish your services and start getting discovered.":
    "إنشاء الملف الشخصي قادم في الخطوة التالية — بمجرد جاهزيته، ستتمكن من نشر خدماتك والبدء في الظهور للعملاء.",

  // Transactional emails (lib/email/auth-emails.ts) — sent server-side, so
  // these go through `dict[locale]` directly rather than `useLocale()`.
  "Verify your email — Qura": "تأكيد بريدك الإلكتروني — قرى",
  "Reset your password — Qura": "إعادة تعيين كلمة المرور — قرى",
  "Hi {{name}},": "مرحباً {{name}}،",
  "Verify your email to activate your Qura profile:":
    "أكّد بريدك الإلكتروني لتفعيل ملفك الشخصي على قرى:",
  "This link expires in 24 hours. If you didn't create a Qura account, you can ignore this email.":
    "تنتهي صلاحية هذا الرابط خلال 24 ساعة. إذا لم تُنشئ حساباً على قرى، يمكنك تجاهل هذه الرسالة.",
  "Reset your Qura password:": "أعد تعيين كلمة مرور حسابك على قرى:",
  "This link expires in 1 hour. If you didn't request this, you can ignore this email.":
    "تنتهي صلاحية هذا الرابط خلال ساعة واحدة. إذا لم تطلب ذلك، يمكنك تجاهل هذه الرسالة.",
};
