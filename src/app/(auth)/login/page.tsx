  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center overflow-auto">
      ...
      <section className="container flex w-full max-w-sm flex-col justify-center gap-5">
        ...
        <div>
          <Form infiniteLoading validation="login-with-password" onSubmit={loginWithPassword} className="grid grid-cols-1 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-end text-xs text-muted-foreground">
                <Link href={Paths.ResetPassword} className="underline underline-offset-4 hover:text-primary">
                  {c["forgot password"]}
                </Link>
              </p>
